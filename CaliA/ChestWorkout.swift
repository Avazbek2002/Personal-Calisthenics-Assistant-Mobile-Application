    ...
    var body: some View {
        ScrollView {
            ...
            VStack(alignment: .leading, spacing:8, content: {
                ...
                Text("The rest between the exercises should be about 90 seconds. Hydrate yourself between the sets. In the last set of each exercse try to go till failure")
                    .padding(.top)
            })
            ...
            VStack (spacing: 8) {
                ListTileView(imageName: "push_ups", title: "Push ups", subtitle: "3x12")
