...
struct BackAndBicepsBeginner: View {
    var body: some View {
        ScrollView {
            ZStack {
                Image("back")
            ...
            VStack(alignment: .leading, spacing:8, content: {
                Label("15 mins, Beginner", systemImage: "timer")
            ...
            VStack (spacing: 8) {
                ListTileView(imageName: "neutral", title: "Neutral Grip Pull ups", subtitle: "2x10 Chest to the bar")
                ListTileView(imageName: "pull_up_bar", title: "Normal Pull ups", subtitle: "2x10 Chest to the bar")
                ListTileView(imageName: "chin_ups", title: "Normal Pull ups", subtitle: "2x10 Chest to the bar")
            }
        }
//        .overlay (alignment: .bottom) {
//            HStack {
